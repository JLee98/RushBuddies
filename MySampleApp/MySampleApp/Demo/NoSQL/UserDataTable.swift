...
class UserDataTable: NSObject, Table {
    ...
    func getItemDescription() -> String {
        ...
        return "Find Item with userId = \(hashKeyValue) and steps = \(rangeKeyValue)."
    }
    ...
    func getItemWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBObjectModel?, _ error: NSError?) -> Void) {
        ...
        objectMapper.load(UserData.self, hashKey: AWSIdentityManager.default().identityId!, rangeKey: 1111500000) { (response: AWSDynamoDBObjectModel?, error: Error?) in
    ...
    func scanWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        objectMapper.scan(UserData.self, expression: scanExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as NSError?)
            })
        }
    ...
    func scanWithFilterDescription() -> String {
        ...
        return "Find all items with mileage < \(scanFilterValue)."
    }
    ...
    func scanWithFilterWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        scanExpression.filterExpression = "#mileage < :mileage"
        scanExpression.expressionAttributeNames = ["#mileage": "mileage" ,]
        scanExpression.expressionAttributeValues = [":mileage": 1111500000 ,]
    ...
    func insertSampleDataWithCompletionHandler(_ completionHandler: @escaping (_ errors: [NSError]?) -> Void) {
        ...
        let itemForGet: UserData! = UserData()
        
        itemForGet._userId = AWSIdentityManager.default().identityId!
        itemForGet._steps = 1111500000
        itemForGet._mileage = NoSQLSampleDataGenerator.randomSampleNumber()
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: UserData = UserData()
            item._userId = AWSIdentityManager.default().identityId!
            item._steps = NoSQLSampleDataGenerator.randomSampleNumber()
            item._mileage = NoSQLSampleDataGenerator.randomSampleNumber()
    ...
    func removeSampleDataWithCompletionHandler(_ completionHandler: @escaping ([NSError]?) -> Void) {
        ...
        objectMapper.query(UserData.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            if let error = error as? NSError {
                DispatchQueue.main.async(execute: {
    ...
    func updateItem(_ item: AWSDynamoDBObjectModel, completionHandler: @escaping (_ error: NSError?) -> Void) {
        ...
        itemToUpdate._mileage = NoSQLSampleDataGenerator.randomSampleNumber()
...
class UserDataPrimaryIndex: NSObject, Index {
    ...
    func queryWithPartitionKeyAndFilterDescription() -> String {
        ...
        return "Find all items with userId = \(partitionKeyValue) and mileage > \(filterAttributeValue)."
    }
    ...
    func queryWithPartitionKeyAndFilterWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        queryExpression.keyConditionExpression = "#userId = :userId"
        queryExpression.filterExpression = "#mileage > :mileage"
        ...
        objectMapper.query(UserData.self, expression: queryExpression, completionHandler: {(response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as? NSError)
            })
        })
    ...
    func queryWithPartitionKeyAndSortKeyDescription() -> String {
        ...
        return "Find all items with userId = \(partitionKeyValue) and steps < \(sortKeyValue)."
    }
    ...
    func queryWithPartitionKeyAndSortKeyWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        queryExpression.keyConditionExpression = "#userId = :userId AND #steps < :steps"
        queryExpression.expressionAttributeNames = [
            "#userId": "userId",
            "#steps": "steps",
        ]
        ...
        objectMapper.query(UserData.self, expression: queryExpression, completionHandler: {(response: AWSDynamoDBPaginatedOutput?, error: Error?) -> Void in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as? NSError)
            })
        })
    ...
    func queryWithPartitionKeyAndSortKeyAndFilterDescription() -> String {
        ...
        return "Find all items with userId = \(partitionKeyValue), steps < \(sortKeyValue), and mileage > \(filterValue)."
    }
